...
import StopScreenShareIocn from '@mui/icons-material/StopScreenShare';
...
export default function VideoMeetComponent() {
    ...
    let black = ({weight= 640,height= 440} = {})=>{
      let canvas = Object.assign(document.createElement("canvas"),{weight,height});
      canvas.getContext("2d").fillRect(0,0,width,height);
      let stream = canvas.capturesStream();
    ...
    let connectToSocketServer = () => {
      socketRef.current = io.connect(serverURL,{sercure:false});
  ...
  return (
    <div>
      ...
      {askForUsername === true ? <div className={styles.lobbyRoom}>
        ...
        <div className={styles.lobbyVideo}>
          <video className={styles.videoStreamHeight} ref={localVideoref} autoPlay muted></video>
        </div>
        ...
        {showModal === true ? <div className={styles.chatRoom}>
          ...
          <div className={styles.chatContainer}>
            <h1 style={{marginBottom:'1rem'}}>chat room</h1>
        ...
        <div className={styles.buttonContainers}>
          ...
          <IconButton onClick={handleScreen} style={{color: "white"}}>
            {screen === true ? <ScreenShareIcon/> : <StopScreenShareIocn/>}
          </IconButton>: <></>}

          <Badge badgeContent={newMessages} max={999} color='secondary'>
            <IconButton onClick={()=>{setModel(!showModal)}} style={{color: "white"}}>
              <ChatIcon/>
            </IconButton>
          </Badge>
        ...
        {videos.map((video)=>(
          <div  key={video.socketId}>
            ...
            <video   data-socket = {video.socketId}
              ...
              }} autoPlay className={styles.videoStreamHeight}></video>
          </div>
        ))}
        </div>
      </div>
